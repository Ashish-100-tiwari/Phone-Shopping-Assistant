          ...
          <div className="bg-gradient-to-br from-white to-gray-50 dark:from-[#252320] dark:to-[#1f1d1b] rounded-2xl p-8 border-2 border-[#e8e6e3] dark:border-[#3a3835] shadow-xl">
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white dark:bg-[#252320] text-gray-500 dark:text-gray-400">Or continue with email</span>
              </div>
            </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <Link href="/auth/signup" className="text-[#8b7355] dark:text-[#a68b6f] font-semibold hover:underline">
                  Sign up
                </Link>
              </p>
            </div>
